        ...
        $(document).ready(function() {
            ...
            $.each(vids, function(index, inVal) {
                Str += '<tr> <td width="200" style="vertical-align: middle"> <p  id="title" name="title" class="text-muted"> ' +inVal.fldName+ '</p></td><td width="300" style="vertical-align: middle"><p id="link" name="link" class="text-muted">' +inVal.fldDescription+ '</p></td><td width="100" style="float: top" style="vertical-align: middle"><a href="/admindelvid/removeVids/' +inVal.fldMediaID+'"><p>DELETE</p></a><!--<button style="font-size: 9px;" id="button0" name="button0" class="button btn btn-sm btn-danger " > Delete </a></button>--></td></tr>';
            });
            $('.mydiv').html(Str);
